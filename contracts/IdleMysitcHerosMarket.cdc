import IdleMysitcToken from "./IdleMysitcToken.cdc"
import IdleMysitcHeros from "./IdleMysitcHeros.cdc"
import FungibleToken from   "./FungibleToken.cdc"
import NonFungibleToken from "./NonFungibleToken.cdc"


pub contract IdleMysitcHerosMarket {
    // SaleOffer events.
    //
    ...
    // SaleOffer
    // A IdleMysitcHeros NFT being offered to sale for a set fee paid in IdleMysitcToken.
    //
    pub resource SaleOffer: SaleOfferPublicView {
        ...
        // The IdleMysitcHeros NFT ID for sale.
        pub let itemID: UInt64
        ...
        access(self) let sellerItemProvider: Capability<&IdleMysitcHeros.Collection{NonFungibleToken.Provider}>

        // The IdleMysitcToken vault that will receive that payment if teh sale completes successfully.
        access(self) let sellerPaymentReceiver: Capability<&IdleMysitcToken.Vault{FungibleToken.Receiver}>

        // Called by a purchaser to accept the sale offer.
        // If they send the correct payment in IdleMysitcToken, and if the item is still available,
        // the IdleMysitcHeros NFT will be placed in their IdleMysitcHeros.Collection .
        //
        pub fun accept(
            buyerCollection: &IdleMysitcHeros.Collection{NonFungibleToken.Receiver},
        ...
        // to transfer the IdleMysitcHeros NFT and the capability to receive IdleMysitcToken in payment.
        //
        init(
            sellerItemProvider: Capability<&IdleMysitcHeros.Collection{NonFungibleToken.Provider}>,
            itemID: UInt64,
            infoID: UInt64,
            sellerPaymentReceiver: Capability<&IdleMysitcToken.Vault{FungibleToken.Receiver}>,
            price: UFix64
        ) {
            pre {
    ...
    pub resource interface CollectionManager {
        pub fun insert(offer: @IdleMysitcHerosMarket.SaleOffer)
    ...
    pub resource Collection : CollectionManager, CollectionPurchaser, CollectionPublic {
        ...
        //
         pub fun insert(offer: @IdleMysitcHerosMarket.SaleOffer) {
            ...
            let infoID: UInt64 = offer.infoID
        ...
        //   2. IdleMysitcHeros.Withdraw
        //   3. IdleMysitcHeros.Deposit
    ...
    init () {
        ...
        self.CollectionStoragePath = /storage/herosMarketCollection5
        self.CollectionPublicPath = /public/herosMarketCollection5
    }
}
