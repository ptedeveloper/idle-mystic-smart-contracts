...
var (
	...
	idleMysitcAddressPlaceHolder      = regexp.MustCompile(`"[^"\s].*/IdleMysitcHeros.cdc"`)
	idleMysticTokenAddressPlaceHolder = regexp.MustCompile(`"[^"\s].*/IdleMysitcToken.cdc"`)
	idleMysticMarketAddressPlaceHolder = regexp.MustCompile(`"[^"\s].*/IdleMysitcHerosMarket.cdc"`)
)
